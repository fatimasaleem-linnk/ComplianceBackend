...
public class ViewRendererService : IViewRendererService
{
    ...
    {
        var getPartialResult = _viewEngine.GetView(executingFilePath: null, viewPath: viewName, isMainPage: true);
        if (getPartialResult.Success)
        {
            return getPartialResult.View;
        }

        var findPartialResult = _viewEngine.FindView(actionContext, viewName, isMainPage: true);
